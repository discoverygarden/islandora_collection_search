...
* [Islandora Solution Pack Collection](https://github.com/discoverygarden/islandora_basic_collection)
...
The configuration page for the module can be found at `yoursite.com/admin/config/islandora/tools/collection_search`.
