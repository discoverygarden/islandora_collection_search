...
class Admin extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['collections']['all_pages'] = [
      ...
      '#description' => $this->t("When selected this will display the collection
        selection box on all pages with the previously selected collection options."),
    ...
    $form['collections']['collection_label'] = [
      ...
      '#description' => $this->t("When selected this will display the current
        collection's label for display as opposed to this collection."),
